  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/sandis.bhargav/"
            ...
            <li>
              <a
                href="https://www.instagram.com/mad_boi_o07?igsh=OGQ5ZDc2ODk2ZA=="
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💚 by Bhargav Sandis</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
